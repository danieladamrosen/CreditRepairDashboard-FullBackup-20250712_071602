...
Due to these reporting inaccuracies and regulatory violations, I am requesting the permanent deletion of this tradeline from my credit report.`;
  ...
  if (!hasAnyNegative && !showPositiveDetails && !expandAll && !showAllDetails) {
    ...
    return (
      <Card className="border border-gray-200 bg-white rounded-lg shadow-sm transition-all duration-300 hover:shadow-lg overflow-hidden">
        <CardHeader
  ...
  return (
    <Card
      className={`transition-all duration-300 shadow-sm hover:shadow-md rounded-lg ${
